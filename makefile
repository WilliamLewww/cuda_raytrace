...
SRCS := main.cpp engine.cpp joiner.cpp input.cpp raytrace_rectangle.cpp raytrace_image.cpp structures.cpp model.cpp font.cpp character_rectangle.cpp text_rectangle.cpp
OBJS := $(SRCS:%.cpp=%.o)

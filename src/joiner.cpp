...
Joiner::Joiner(ShaderHandler* shaderHandler, FontHandler* fontHandler, ModelHandler* modelHandler) {
  ...
  modelHandler->updateTransformation(0, 0.0, 0.0, 0.0, 5.0, 0.15, 5.0, 0.0, 0.0);
  modelHandler->updateTransformation(1, 0.0, -2.0, 0.0, 1.0, 1.0, 1.0, 0.0, 0.0);
  modelHandler->updateTransformation(2, 1.0, -2.0, 1.0, 1.0, 1.0, 1.0, 0.0, 0.0);
